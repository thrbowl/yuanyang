...
# Message Template
MESSAGE_ADD_PROJECT = u'MESSAGE_ADD_PROJECT'
MESSAGE_AUDIT_PASS = u'MESSAGE_AUDIT_PASS'
MESSAGE_AUDIT_REJECT = u'MESSAGE_AUDIT_REJECT'
MESSAGE_PROJECT_ENDED = u'MESSAGE_PROJECT_ENDED'
MESSAGE_PROJECT_COMMENTED = u'MESSAGE_PROJECT_COMMENTED'
MESSAGE_PROJECT_COMPLETED = u'MESSAGE_PROJECT_COMPLETED'
